...
import com.hungdt.test.view.LoadingDialog;
import com.hungdt.test.view.MainActivity;
            ...
            public void onClick(View v) {
                if (Helper.isConnectedInternet(getActivity())){
                    ...
                    if(MySetting.getGems(getContext())>0){
                        ...
                        Toast.makeText(getContext(), "Watch a video to get more gems!!!", Toast.LENGTH_SHORT).show();
                    }
                }
