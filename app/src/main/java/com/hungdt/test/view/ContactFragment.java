        ...
        * */
        ...
        private void readAccountContacts() {
            ...
            while (cursorContact != null && cursorContact.moveToNext()) {
                ...
                if (image != null) {
                    DBHelper.getInstance(getLayoutInflater().getContext()).addContact(idContact, name, image, lastCT, KEY.FALSE);
                } else {
                    DBHelper.getInstance(getLayoutInflater().getContext()).addContact(idContact, name, KEY.IMAGE, lastCT, KEY.FALSE);
                }
